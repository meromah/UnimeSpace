...
const MarkdownViewer = ({ children }) => {
  const components = {
    ...
    h2: ({ node, ...props }) => (
      <h2
        className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mb-3 mt-5 first:mt-0 leading-tight"
        {...props}
      />
    ),
    h3: ({ node, ...props }) => (
    ...
    h4: ({ node, ...props }) => (
      <h4
        className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-2 mt-3 first:mt-0 leading-tight"
        {...props}
      />
    ),
    h5: ({ node, ...props }) => (
