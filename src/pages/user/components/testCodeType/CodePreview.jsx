    ...
    <>
      ...
      {showCodePreview && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 dark:bg-black/70 backdrop-blur-sm p-4">
          <div className="w-full min-h-[80vh] max-w-6xl max-h-[90vh] bg-white dark:bg-neutral-900 rounded-lg shadow-xl flex flex-col overflow-hidden">
            {/* Header */}
            ...
            <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
              ...
              <div className="w-full md:w-1/2 p-4 md:p-6 overflow-y-auto border-r border-neutral-200 dark:border-neutral-700">
                <div className="flex flex-col gap-4">
                  ...
                  {question.signature && (
                    <div>
                      ...
                      <code className="block px-3 py-2 bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded text-sm text-neutral-900 dark:text-neutral-100 font-mono">
              ...
              <div className="w-full md:w-1/2 p-4 md:p-6 overflow-y-auto bg-neutral-50 dark:bg-neutral-800">
                <div className="flex flex-col gap-4 h-full">
                  ...
                  <button
                    ...
                    className="px-4 py-2 text-sm bg-primary-blue dark:bg-blue-500 text-white rounded-lg hover:bg-primary-blue/90 dark:hover:bg-blue-600 disabled:bg-neutral-300 dark:disabled:bg-neutral-700 disabled:cursor-not-allowed transition-colors font-medium"
                  >
                  ...
                  {pythonOutput.length > 0 && (
                    <div className="p-3 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-lg">
                      ...
                      {pythonOutput.map((test_case, i) => (
                        <pre key={i} className="text-xs text-neutral-900 dark:text-neutral-100 font-mono whitespace-pre-wrap">
                          {test_case.stdout}
                        </pre>
                      ))}
                    </div>
