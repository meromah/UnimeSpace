        ...
        <div className="p-6">
          ...
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-500 mt-2">
              Blocking <strong>allows users to view</strong> content but prevents them from other
              community actions. Do you want to continue?
            </p>
            {member && (
              <p className="text-sm text-gray-700 mt-3 font-medium">
                User: <span className="text-gray-900">u/{member.username}</span>
              </p>
            )}
          </div>
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
            ...
            <button
              ...
              disabled={isProcessing}
              className="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-500 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors font-medium cursor-pointer"
            >
